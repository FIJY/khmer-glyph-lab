...
import { resolveGlyphParts } from "../lib/khmerSegmentationEngine.js";
...
export default function VisualDecoderLab() {
  ...
  // Вычисляем parts для каждого глифа в одном движке сегментации
  const glyphsWithParts = useMemo(() => {
    return glyphs.map((glyph) => ({
      ...glyph,
      parts: resolveGlyphParts(glyph, units, enableSegmentation),
    }));
